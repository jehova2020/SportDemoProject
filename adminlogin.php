<?php 
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST") 
  {
    ...
    $rows=$mongo->executeQuery("esports.admin",$qry);
...
<html class="no-js" lang="en">
  ...
  <body>
    ...
    <form method="POST" action="adminlogin.php" style="margin-top:30px;">
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="password" id="right-label" name="password" placeholder="***" required>
            </div>
          </div>
