...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Products || eSports Shop</title>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <div class="large-4 columns">
              ...
              <div>
                <h5 class="item_price"><?= $myQuestion->ProductID ?></h5>
              </div>
              ...
              <div>
                ...
                <p><input type="submit"name="addtocart" value="Add To Cart" style="clear:both; background: #0078A0; border: none; color: #fff; font-size: 1em; padding: 10px;" /></a></p>
